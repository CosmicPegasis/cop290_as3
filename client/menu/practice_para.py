    ...
    def handle_selection(self, selected_option):
        if selected_option == 0:
            ...
            if(self.narrate_name):
                ...
                self.play_sound("off")
            self.new_screen = Parameters_practice(self.narrate_name,self.narrate_pitch,self.note_length,selected_option)
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_UP:
                    ...
                    if self.selected_option == 3:
                        self.note_length = self.note_length+1
                        self.switch_screen = True
                        self.new_screen = Parameters_practice(self.narrate_name,self.narrate_pitch,self.note_length,self.selected_option)
